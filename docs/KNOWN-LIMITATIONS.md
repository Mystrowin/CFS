# CFS 0.1.0 Beta known limitations
...
- Saving is explicit. Changes in Explorer are not durable in the `.cfs` until **Save Mounted Changes** or the save-and-unmount workflow succeeds.
