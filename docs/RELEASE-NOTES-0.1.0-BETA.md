...
Representative 1,000-file and large-file measurements are recorded in [PERFORMANCE-BASELINE.md](PERFORMANCE-BASELINE.md). They are regression evidence, not performance guarantees.
