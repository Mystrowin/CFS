# CFS 0.1.0 Beta contributor access policy
...
1. Submit a contribution through the project-owner-provided channel using the [bug-report template](BUG-REPORT-TEMPLATE.md) when applicable.
...
CFS 0.1.0 Beta does not include a licensing backend for this program. Submission, discussion, or acceptance of a report does not by itself grant access.
