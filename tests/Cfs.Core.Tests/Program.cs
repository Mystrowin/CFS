...
{
    Assert(CfsProductInfo.ReleaseIdentity == "0.1.0 Beta", $"unexpected release identity: {CfsProductInfo.ReleaseIdentity}");
    Assert(CfsProductInfo.DisplayName == "CFS 0.1.0 Beta", $"unexpected display name: {CfsProductInfo.DisplayName}");
    ...
    Assert(CfsProductInfo.BuildIdentifier.StartsWith("0.1.0-Beta-", StringComparison.Ordinal), $"build identifier lacks beta identity: {CfsProductInfo.BuildIdentifier}");
